...
import StudentDeletion from './screens/TeacherScreen/StudentDeletion';
import RewardPunishmentSettings from './screens/TeacherScreen/RewardPunishmentSettings';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login" screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="StudentDeletion" component={StudentDeletion} />
        <Stack.Screen name="RewardPunishmentSettings" component={RewardPunishmentSettings} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}